...
def Almond_Qual(frame):
    try:
        ...
        for contour in contours:
            ...
            elif 2000 <= c <= 10000:  # broken class
                x, y, w, h = cv2.boundingRect(contour)
        ...
        print(
            "Total Almond={} , Soaked Almond={}, Dry Almond={},Broken Almond={}".format(total_count, len((soked_bounding)),
                                                                                        len((dry_bounding)),
                                                                                        len((broken_bounding))))
        ...
        cv2.putText(frame, "Dry Almond ={} %".format(format_perdry), (20, 55), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255),
                    2)
        ...
        cv2.putText(frame, "broken Almond ={} %".format(format_perbad), (20, 85), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (255, 255, 255), 2)
