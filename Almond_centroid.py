...
print( "Total Almond={} , Soaked Almond={}, Dry Almond={},Broken Almond={}".format(total_count,len((soked_bounding)),len((dry_bounding)),len((broken_bounding))))
...
print(format_perbad)
cv2.putText(frame,  "Defected Almond ={} %".format(format_perbad), (20,85), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 2)
